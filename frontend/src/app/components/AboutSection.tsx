...
const AboutSection = () => {
  return (
    <section id="about" className="cursor-default scroll-mt-64 px-4 sm:px-12 lg:px-16 xl:px-24">
      <div className="min-h-screen mx-auto grid w-full grid-cols-1 md:grid-cols-2 gap-12 justify-between items-center">
        {/* Image */}
        <div className="relative w-full h-[400px] md:h-[500px]">
          <Image src="/team.jpg" alt="О нас" fill className="object-cover rounded-2xl" />
        </div>
